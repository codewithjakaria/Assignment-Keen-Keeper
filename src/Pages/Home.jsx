...
import { ArrowLeft, Trash2, BellOff, Archive, Plus } from 'lucide-react';
...
export default function Home() {
  const { selectedFriend, setSelectedFriend, addActivity } = useOutletContext();
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {FRIENDS.map(friend => (
            ...
            >
              ...
              <p className="text-xs text-[#94A3B8] mb-4">{friend.days}d ago</p>
